-- 060 — คืนเมนู Menu Builder ใน sidebar หลัก (กรณีรัน 059 เวอร์ชัน DELETE ไปแล้ว)
-- รัน: psql "$DATABASE_URL" -v ON_ERROR_STOP=1 -f database/migrations/060_restore_admin_menu_tbmenu.sql
